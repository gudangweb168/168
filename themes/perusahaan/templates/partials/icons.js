/* ============================================================
   ...
   - lineIcon(name): ikon garis serbaguna (dipakai blok kontak).
...
// Ikon garis untuk kartu layanan & blok kontak (stroke = currentColor).
var FEATURE = {
  ...
  building: '<path d="M3 21h18"/><path d="M5 21V5a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v16"/><path d="M15 21V9h3a1 1 0 0 1 1 1v11"/><path d="M9 8h.01M9 12h.01M9 16h.01"/>',
  handshake: '<path d="m11 17 2 2a1 1 0 0 0 1.4 0l3.6-3.6a1 1 0 0 0 0-1.4l-3-3"/><path d="m14 9-2-2a1 1 0 0 0-1.4 0L7 10.6a1 1 0 0 0 0 1.4l3 3"/><path d="M3 11 8 6"/><path d="m16 18 5-5"/>',
...
// Ikon garis serbaguna (ukuran diatur lewat CSS). Dipakai blok kontak.
...
module.exports = { socialLinks, featureIcon, lineIcon, arrow };
