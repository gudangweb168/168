/* ============================================================
   ...
   Header lengket (sticky) berisi logo, menu (mendukung submenu),
   dan satu tombol CTA opsional (dari Sesuaikan → Tombol CTA Header).
   Mobile: menu menjadi drawer geser dari kanan (lihat script.js).
   ============================================================ */
...
module.exports = function header(ctx) {
  ...
  // Pada tampilan mobile, tombol ini disembunyikan via CSS (.nav-cta).
  ...
  var brand = config.logo
    ...
    : '<a href="' + attr(U.url("/")) + '" class="site-logo"><span class="site-logo-mark" aria-hidden="true"></span>' + esc(config.title) + "</a>";
