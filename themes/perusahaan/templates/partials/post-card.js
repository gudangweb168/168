/* ============================================================
   ...
   Dipakai di beranda (seksi Berita) & arsip kategori/tag.
...
module.exports = function postCard(post, ctx) {
  ...
  var img = post.ogImage
    ...
    : '<a href="' + attr(U.url(post.permalink)) + '" class="card-thumb card-thumb-ph" aria-hidden="true" tabindex="-1"><span></span></a>';

  return (
    '\n      <article class="post-card has-thumb">' +
    "\n        " + img +
    '\n        <div class="card-body">' +
    "\n          " + cat +
